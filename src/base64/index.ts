...
function work (): void {
  ...
  let _utf8_encode = (str: string): string => {
    str = str.replace(/\r\n/g,"\n");
    let utftext: string = '';
  ...
  let _utf8_decode = (utftext: string): string => {
    let str: string = '';
    let i: number = 0, len: number = utftext.length;
